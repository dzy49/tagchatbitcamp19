        ...
        <div>
          ...
          <div class="foot-input">
            <textarea v-model="message"
                      ref="textarea"
                      placeholder="please eneter the message"
...
import TagBar from '../../sidebar/tag-bar';
export default {
  name: 'chat-box',
  components: {
    DefaultPage,
  ...
  computed: {
    ...
    getfromtagbar(){
      return this.$refs.tagbarref.tag[0];
    }
  ...
  methods: {
    getbarchecked(num){
      return this.$refs.tagbarref.ifchecked(num);
    },
    getfromtagbar3(){
      return this.$refs.tagbarref.tag;
    },
    getfromtagbar5(){
      return this.$refs.tagbarref.selected();
    },
    getContactInfo() {
